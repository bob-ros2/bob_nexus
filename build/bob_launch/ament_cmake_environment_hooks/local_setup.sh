...
: ${AMENT_CURRENT_PREFIX:="/blue/dev/skills/install/bob_launch"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bob_launch/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bob_launch/environment/path.sh"
